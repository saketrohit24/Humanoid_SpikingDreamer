#!/bin/bash
# Direct run script for Humanoid-v4 BASELINE (no dreaming)
# Usage: nohup bash run_humanoid_baseline_2M.sh > logs/humanoid_v4_baseline.log 2>&1 &

set -e
echo "=========================================="
echo "  BASELINE RUN — Humanoid-v4, 2M steps"
echo "  Started: $(date)"
echo "=========================================="
